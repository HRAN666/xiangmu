<template>
    <div>
        <header-general routerTo="/Home" headTitle="代取其他" headClass="style5"></header-general>       
        <div class="gooods-message">
            <div class="goods-img">
                <img src="../assets/details_wati_expresselse.png" alt="">
            </div>
            <div class="goods-title">代取其他</div>
        ...
        <div class="recommend-goods">
            ...
            <div class="recommend-goods-img">
                <a href="express"><img src="../assets/wati_express.png" alt=""></a>
                代取快递
        ...
        <div class="express-message"  v-bind:style="{display: state}">
            <div class="express-message-img">
                <img src="../assets/wait_serve.png" alt="">
            </div>
            <div class="express-message-right">
                <div class="express-message-right-title">代取其他</div>
